...
class Settings(BaseSettings):
    ...
    # CTA-ссылка в конце каждого поста (чтобы при пересылке друзья перешли в бота).
    # Пусто в URL → строки нет.
    cta_text: str = "FlatLikeThat — найти квартиру"
    ...
    public_min_appeal: int = 0  # 0 = не фильтровать по appeal
