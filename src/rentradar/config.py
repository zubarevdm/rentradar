...
class Settings(BaseSettings):
    ...
    # Потолок цены для паблик-канала, ₽/мес. Аудитория ищет оптимальную по цене
    # квартиру, а не «офигенную за любые деньги» — дорогие лоты красивы почти
    # всегда, это не витрина. 0 = без потолка.
    public_max_price: int = 100_000
